    ...
    <div class="nav-right">
        <div class="nav-btns">
            ...
            <div class="menu" id="menuContainer" aria-hidden="true">
                <a href="#" class="menu-item" onclick="handleMenuItemClick(event, 'mirror-view')" data-key="mirrorView">${
                  staticTexts.mirrorView[language]
                }</a>
                <a href="index.html" class="menu-item">Home</a>
                <a href="javascript:void(0);" class="menu-item" onclick="openRulesPopup()" data-key="gameRules">${
                  staticTexts.gameRules[language]
                }</a>
...
function decreaseValue() {
  ...
  if (value > 2) {
    value--;
    document.getElementById("currentGoalValue").textContent = value;
    updateGoal(value);
  }
    uploadGameData();
}
...
function updateGoal(value) {
  goalValue = value;
  document.getElementById("currentGoalValue").textContent = goalValue;
}
